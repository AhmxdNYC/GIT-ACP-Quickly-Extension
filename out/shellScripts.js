...
exports.getShellFunctionScript = void 0;
function getShellFunctionScript(version, shell) {
    if (shell === 'fish') {
        return getFishFunctionScript(version);
    }
    return getBashZshFunctionScript(version);
}
exports.getShellFunctionScript = getShellFunctionScript;
function getBashZshFunctionScript(version) {
    return `
...
function getFishFunctionScript(version) {
    return `
# BEGIN: ACP Function - Git Add, Commit, Push - ACP Version: ${version} - DO NOT MODIFY THIS BLOCK MANUALLY #
# ACP Version: ${version}
...
//# sourceMappingURL=shellScripts.js.map